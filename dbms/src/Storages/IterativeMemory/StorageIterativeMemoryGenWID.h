...
/** Implements storage in the RAM.
  ...
  */
class StorageIterativeMemoryGenWID : public ext::shared_ptr_helper<StorageIterativeMemoryGenWID>, public IStorage
{
friend class IterativeMemoryGenWIDBlockInputStream;
friend class IterativeMemoryGenWIDBlockOutputStream;
friend struct ext::shared_ptr_helper<StorageIterativeMemoryGenWID>;
...
protected:
    StorageIterativeMemoryGenWID(String database_name_, String table_name_, ColumnsDescription columns_description_, ConstraintsDescription constraints_);
};
