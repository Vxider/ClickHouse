...
/** Implements storage in the RAM.
  ...
  */
class StorageIterativeMemoryGenTime : public ext::shared_ptr_helper<StorageIterativeMemoryGenTime>, public IStorage
{
friend class IterativeMemoryGenTimeBlockInputStream;
friend class IterativeMemoryGenTimeBlockOutputStream;
friend struct ext::shared_ptr_helper<StorageIterativeMemoryGenTime>;
...
protected:
    StorageIterativeMemoryGenTime(String database_name_, String table_name_, ColumnsDescription columns_description_, ConstraintsDescription constraints_);
};
